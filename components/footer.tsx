      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4">
          ...
          <div className="font-mono text-xs opacity-50">
            Built by <a href="https://adampang.com" className="underline hover:opacity-100">Adam Pangelinan</a>
            {' · '}<a href="https://sellsniper.com" className="underline hover:opacity-100">More projects</a>
          </div>
        </div>
      </div>
    </footer>
